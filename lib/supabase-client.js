...
async function trackDeviceLogin(userId, deviceFingerprint, deviceInfo) {
  ...
  try {
    ...
    console.log("[v0] trackDeviceLogin: Existing device check result:", { existingDevice, checkError })
    ...
    if (existingDevice) {
      ...
      // Insert new device
      console.log("[v0] trackDeviceLogin: Inserting new device...")
...
async function login(email, pin) {
  ...
  console.log("[v0] login: window.DeviceFingerprint exists?", !!window.DeviceFingerprint)
